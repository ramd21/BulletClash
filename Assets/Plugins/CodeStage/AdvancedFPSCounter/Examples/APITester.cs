...
namespace CodeStage.AdvancedFPSCounter
{
	public class APITester : MonoBehaviour
	{
		...
		private void OnGUI()
		{
			GUILayout.BeginArea(new Rect(40, 110, Screen.width-80, Screen.height - 80));
			...
			if (AFPSCounter.Instance.memoryCounter.Precise)
			{
				GUILayout.Label("<size=11>  Memory (Total, Allocated, Mono):\n  " +
								...
								AFPSCounter.Instance.memoryCounter.LastMonoValue / (float)MemoryCounterData.MEMORY_DIVIDER + "</size>");
			}
			else
			{
				GUILayout.Label("<size=11>  Memory (Total, Allocated, Mono):\n  " +
								...
								AFPSCounter.Instance.memoryCounter.LastMonoValue + "</size>");
			}
		...
		private void DrawDeviceInfoTab()
		{
			...
			GUILayout.BeginHorizontal();
			AFPSCounter.Instance.deviceInfoCounter.GpuModel = GUILayout.Toggle(AFPSCounter.Instance.deviceInfoCounter.GpuModel, "GPU Model", GUILayout.ExpandWidth(false));
			GUILayout.Space(10);
			AFPSCounter.Instance.deviceInfoCounter.GpuApi = GUILayout.Toggle(AFPSCounter.Instance.deviceInfoCounter.GpuApi, "GPU API", GUILayout.ExpandWidth(false));
			GUILayout.Space(10);
			AFPSCounter.Instance.deviceInfoCounter.GpuSpec = GUILayout.Toggle(AFPSCounter.Instance.deviceInfoCounter.GpuSpec, "GPU Spec", GUILayout.ExpandWidth(false));
			GUILayout.EndHorizontal();
			GUILayout.EndVertical();
			GUILayout.BeginVertical();
