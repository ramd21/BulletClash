...
Shader "Custom/Planet"
{
	Properties
	{
		...
		_Ambiantalbedo("Ambiant albedo", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_cast_2 = (tex2DNode26.a).xxxx;
			o.Normal = lerp( float3(0.5,0.5,1) , UnpackNormal( tex2D( _Normalmap,uv_Normalmap) ) , ( ( 1.0 - lerp(temp_cast_2,float4(0,0,0,0),_Desactivateclouds) ) * _Normalintensity ).r );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float2 temp_cast_4 = (dot( UnityWorldSpaceLightDir( i.worldPos ) , ase_worldNormal )).xx;
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float4 temp_cast_6 = (tex2DNode26.a).xxxx;
			float3 desaturateVar142 = lerp( lerp( ( tex2D( _Albedo,uv_Albedo) * _Albedocolor ) , _cloudscolor , lerp(temp_cast_6,float4(0,0,0,0),_Desactivateclouds).r ).rgb,dot(lerp( ( tex2D( _Albedo,uv_Albedo) * _Albedocolor ) , _cloudscolor , lerp(temp_cast_6,float4(0,0,0,0),_Desactivateclouds).r ).rgb,float3(0.299,0.587,0.114)),_Desaturation);
			o.Albedo = ( tex2D( _LookupSunset,temp_cast_4) * float4( desaturateVar142 , 0.0 ) ).xyz;
			float3 worldViewDir = normalize( UnityWorldSpaceViewDir( i.worldPos ) );
			float fresnelFinalVal9 = (0.0 + _Subatmosphereglobalintensity*pow( 1.0 - dot( ase_worldNormal, worldViewDir ) , _Subatmospherepower));
			float2 uv_Emissivecities = i.uv_texcoord * _Emissivecities_ST.xy + _Emissivecities_ST.zw;
			o.Emission = clamp( lerp( ( ( clamp( ( ( dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) * fresnelFinalVal9 ) * _Subatmospherecolor ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) ) + ( ( tex2DNode26.a * ( clamp( pow( ( 1.0 - dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) ) , 5.0 ) , 0.0 , 1.0 ) * ( tex2D( _Emissivecities,uv_Emissivecities) * _Citiescolor ) ) ) * _Citiesintensity ) ) + ( _Ambiantcolor * clamp( pow( ( 1.0 - dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) ) , 5.0 ) , 0.0 , 1.0 ) ) ) , ( float4( desaturateVar142 , 0.0 ) + ( ( clamp( ( ( dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) * fresnelFinalVal9 ) * _Subatmospherecolor ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) ) + ( ( tex2DNode26.a * ( clamp( pow( ( 1.0 - dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) ) , 5.0 ) , 0.0 , 1.0 ) * ( tex2D( _Emissivecities,uv_Emissivecities) * _Citiescolor ) ) ) * _Citiesintensity ) ) + ( _Ambiantcolor * clamp( pow( ( 1.0 - dot( ase_worldNormal , UnityWorldSpaceLightDir( i.worldPos ) ) ) , 5.0 ) , 0.0 , 1.0 ) ) ) ) , _Ambiantalbedo ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) ).rgb;
			float4 temp_cast_15 = (tex2DNode26.a).xxxx;
			float2 uv_watermask = i.uv_texcoord * _watermask_ST.xy + _watermask_ST.zw;
			float4 tex2DNode82 = tex2D( _watermask,uv_watermask);
			float4 temp_cast_17 = (tex2DNode82.a).xxxx;
...
/*ASEBEGIN
Version=7003
7;29;2546;1364;1046.52;-174.9317;1.704411;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1530.469,-486.8766;Float;False;Property;_Cloudspeed;Cloud speed;18;0;0.2;0;0.2;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;45;-1051.071,1252.358;Float;True;Property;_Emissivecities;Emissive (cities);9;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ColorNode;47;-1005.903,1446.96;Float;False;Property;_Citiescolor;Cities color;10;0;1,0.815662,0.559,0;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;26;-502.1509,-247.1661;Float;True;Property;_CloudsAlpha;Clouds (Alpha);16;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;114;-1294.459,-981.5358;Float;False;Property;_Albedocolor;Albedo color;5;0;1,1,1,0;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;69;-43.74596,1307.933;Float;False;Property;_Citiesintensity;Cities intensity;11;0;0;0;5;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;116;442.0899,947.0967;Float;False;Property;_Ambiantcolor;Ambiant color;20;0;0,0,0,0;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;67;-168.4022,-510.3954;Float;False;Property;_cloudscolor;clouds color;17;0;0.4338235,0.4338235,0.4338235,0;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.CommentaryNode;130;737.1013,386.4348;Float;False;204;183;Emissive 1st pass;1;76;
...
Node;AmplifyShaderEditor.ToggleSwitchNode;105;-133.1977,-325.8942;Float;False;Property;_Desactivateclouds;Desactivate clouds;19;1;[Toggle];0;0;FLOAT;0.0;False;1;COLOR;0.0;False;COLOR
...
Node;AmplifyShaderEditor.CommentaryNode;120;-603.587,-1284.305;Float;False;1143.281;544.1838;Sunset ramp;4;93;95;94;91;
Node;AmplifyShaderEditor.CommentaryNode;126;1080.895,773.274;Float;False;1126.196;490.5001;Specular map / gloss;6;83;112;80;110;78;82;
...
Node;AmplifyShaderEditor.RangedFloatNode;144;456.9279,-117.5811;Float;False;Property;_Desaturation;Desaturation;6;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleAddOpNode;76;747.1012,433.2348;Float;False;0;COLOR;0.0,0,0,0;False;1;COLOR;0.0;False;COLOR
Node;AmplifyShaderEditor.CommentaryNode;131;1608.915,413.061;Float;False;305.0802;291.3;Emissive 2nd pass;1;118;
...
Node;AmplifyShaderEditor.SamplerNode;82;1130.895,1042.224;Float;True;Property;_watermask;water mask;12;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleAddOpNode;118;1655.305,463.061;Float;True;0;COLOR;0.0,0,0,0;False;1;COLOR;0.0;False;COLOR
Node;AmplifyShaderEditor.RangedFloatNode;90;1594.027,1945.111;Float;False;Property;_Normalintensity;Normal intensity;8;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.SimpleAddOpNode;110;1566.498,1083.878;Float;False;0;FLOAT;0.0;False;1;FLOAT4;0.0;False;FLOAT4
Node;AmplifyShaderEditor.DotProductOpNode;94;-255.9704,-1095.659;Float;False;0;FLOAT3;0.0;False;1;FLOAT3;0,0,0;False;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;78;1246.491,837.7971;Float;False;Property;_Gloss;Gloss;13;0;0.81;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;152;1951.526,434.1182;Float;False;Property;_Ambiantalbedo;Ambiant albedo;4;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.WireNode;136;1095.292,1703.429;Float;False;0;COLOR;0.0;False;COLOR
Node;AmplifyShaderEditor.SimpleAddOpNode;150;1919.226,198.5183;Float;False;0;FLOAT3;0,0,0,0;False;1;COLOR;0,0,0;False;COLOR
Node;AmplifyShaderEditor.LerpOp;151;2126.326,251.7182;Float;False;0;COLOR;0.0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.0;False;COLOR
Node;AmplifyShaderEditor.ClampOpNode;112;1707.067,1082.247;Float;False;0;FLOAT4;0.0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;1,1,1,1;False;FLOAT4
...
Node;AmplifyShaderEditor.SamplerNode;85;1607.393,1394.588;Float;True;Property;_Normalmap;Normal map;7;0;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;1611.156,823.2739;Float;True;0;COLOR;0.0;False;1;FLOAT;0.0,0,0,0;False;COLOR
Node;AmplifyShaderEditor.SamplerNode;91;218.694,-1010.264;Float;True;Property;_LookupSunset;Lookup Sunset;14;0;Assets/Exo planets/Textures/Lookup Sunset.tga;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.CommentaryNode;121;1433.203,-228.7519;Float;False;284.9999;303;Albedo 3rd pass;1;99;
Node;AmplifyShaderEditor.Vector3Node;87;1636.025,1608.925;Float;True;Constant;_Vector0;Vector 0;15;0;0.5,0.5,1;FLOAT3;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ClampOpNode;153;2338.226,353.4183;Float;False;0;COLOR;0.0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;99;1518.403,-172.1519;Float;True;0;FLOAT4;0.0;False;1;FLOAT3;0,0,0,0;False;FLOAT4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;1911.341,986.4008;Float;False;0;COLOR;0,0,0,0;False;1;FLOAT4;0.0,0,0,0;False;FLOAT4
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2709.519,384.0583;Float;False;True;2;Float;ASEMaterialInspector;0;Standard;Custom/Planet;False;False;False;False;True;False;True;True;True;True;False;False;Back;1;0;False;100000;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;DstColor;SrcColor;0;Zero;Zero;Add;Add;0;False;2.5;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;13;OBJECT;0.0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False
...
ASEEND*/
//CHKSM=5137479A43B334B0FE31C6D989FADEC38105B253